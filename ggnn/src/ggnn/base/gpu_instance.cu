...
// #if !defined(GGNN_HAS_PYTHON)
// #if defined(__has_include)
// #if __has_include(<Python.h>)
// #define GGNN_HAS_PYTHON 1
// #else
// #define GGNN_HAS_PYTHON 0
// #endif
// #else
// #define GGNN_HAS_PYTHON 0
// #endif
...
// Releases the Python GIL while waiting on CUDA events to avoid blocking other Python threads.
struct ScopedPythonGILRelease {
#if GGNN_HAS_PYTHON
  ScopedPythonGILRelease()
  {
    if (Py_IsInitialized())
...
#else
  ScopedPythonGILRelease() = default;
  ~ScopedPythonGILRelease() = default;
#endif
};
